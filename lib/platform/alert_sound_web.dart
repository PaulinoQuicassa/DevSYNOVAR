...
/// de aviso sonoro (dois tons) directamente via Web Audio API
/// (`package:web`, a forma actual e compatível com WASM de interagir
/// com APIs do browser -- `dart:web_audio`/`dart:html` já não existem
/// neste SDK), tal como já é feito em
/// fila-certa-staff/src/pages/PublicDisplay.tsx.
void playAlertSound() {
  try {
    final ctx = web.AudioContext();
    for (final (frequency, start) in [(880.0, 0.0), (660.0, 0.18)]) {
