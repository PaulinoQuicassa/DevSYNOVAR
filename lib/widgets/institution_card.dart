...
/// 0.5px. Substitui `LocationCard` como o cartão de referência da app --
/// mantém o mesmo comportamento (distância real, contagem ao vivo,
/// favorito), só com a linguagem visual nova. A categoria (verde-menta =
/// serviço público, âmbar = banco) continua a aparecer na pílula "ao
/// vivo"/pessoas -- a barra vertical de cor à parte foi retirada por
/// ser redundante e sem função clara para quem usa a app.
